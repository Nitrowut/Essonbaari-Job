			...
			trigger = {
				...
				active = {
					callback = function()
						...
						local number =distance/v.dancefloor.Marker.w
						local volume = round(((2-number)/10), 3)
...
function OpenDjMenu(dancefloor)
	local elements = {}
	table.insert(elements, {label = 'Jatka toistamista', value = 'play_music'})
	table.insert(elements, {label = 'Keskeytä musiikin toisto', value = 'pause_music'})
	table.insert(elements, {label = 'Lopeta Musiikin toisto', value = 'stop_music'})
