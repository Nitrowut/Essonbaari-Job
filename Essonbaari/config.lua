...
Config.AuthorizedVehicles = {
    { name = 'wildtrak',  label = 'Ford Bronco Wildtrak' },
}

Config.Blips = {
    Blip = {
      Pos     = { x = 841.62, y = -114.30, z = 79.88 },
      Sprite  = 121,
      Display = 4,
      Scale   = 1.2,
      Colour  = 27,
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = 825.18, y = -115.22, z = 79.50 },
        SpawnPoint   = { x = 823.60, y = -123.30, z = 80.30 },
